...
document.querySelector('#save').addEventListener('click', () => {
  ...
  xmlhttp.onloadend = function(e) {
    ...
    const postCardLink = window.location.protocol + '://' + window.location.host + "/display.html?id=" + id;
    const hrefEle = document.getElementById('postCardLink');
    hrefEle.attributes['href'] = postCardLink;
    hrefEle.innerHTML = postCardLink;
